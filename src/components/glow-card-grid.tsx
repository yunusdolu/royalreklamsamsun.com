...
/**
 * NOT: Kataloğun örnek `GlowCard` (avatar kartı) bileşeni kaldırıldı.
 * Bu projede kartların içeriğini kendimiz kuruyoruz; imleç takibi yapan
 * `GlowCardGrid` sarmalayıcısı korunuyor, altın parıltı katmanları ise
 * `components/ui/glow-surface.tsx` içinde tanımlı.
 */
