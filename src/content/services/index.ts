...
const definitions: Omit<Service, "copy">[] = [
  {
    ...
    icon: "Lightbulb",
    image: "/images/services/isikli-tabela.jpg",
    featured: true,
    leadTimeDays: [5, 10],
  },
  {
    ...
    icon: "Type",
    image: "/images/services/kutu-harf-tabela.jpg",
    featured: true,
    leadTimeDays: [7, 12],
  },
  {
    ...
    icon: "Milestone",
    image: "/images/services/totem-tabela.jpg",
    featured: true,
    leadTimeDays: [10, 20],
  },
  {
    ...
    icon: "SquareStack",
    image: "/images/services/lightbox-tabela.jpg",
    featured: true,
    leadTimeDays: [4, 8],
  },
  {
    ...
    icon: "Building2",
    image: "/images/services/cephe-giydirme.jpg",
    featured: true,
    leadTimeDays: [7, 28],
  },
  {
    ...
    icon: "Car",
    image: "/images/services/arac-giydirme.jpg",
    featured: true,
    leadTimeDays: [1, 3],
  },
  {
    ...
    icon: "Printer",
    image: "/images/services/dijital-baski.jpg",
    featured: false,
    leadTimeDays: [1, 3],
  },
  {
    ...
    icon: "Palette",
    image: "/images/services/kurumsal-kimlik.jpg",
    featured: false,
    leadTimeDays: [7, 21],
  },
  {
    ...
    icon: "Tags",
    image: "/images/services/etiket-sticker.jpg",
    featured: false,
    leadTimeDays: [1, 3],
  },
  {
    ...
    icon: "HardHat",
    image: "/images/services/imalat-tasarim-montaj.jpg",
    featured: false,
    leadTimeDays: [5, 15],
  },
  {
    ...
    icon: "SignpostBig",
    image: "/images/services/yol-panolari.jpg",
    featured: false,
    leadTimeDays: [10, 15],
  },
  {
    ...
    icon: "MonitorPlay",
    image: "/images/services/led-ekranlar.jpg",
    featured: false,
    leadTimeDays: [15, 30],
  },
];
