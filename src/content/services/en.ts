...
export const servicesEn: Record<string, ServiceCopy> = {
  "isikli-tabela": {
    ...
    shortName: "Illuminated Signs",
    tagline: "Readable after dark",
    summary:
    ...
    keywords: [
      ...
      "led signs turkey",
      "shopfront sign manufacturer samsun",
    ...
    highlights: [
      ...
      },
      {
        ...
        description: "Up to 60% savings versus fluorescent or neon equivalents.",
      },
      {
    ...
    specs: [
      { label: "Cabinet", value: "Aluminium composite or galvanised steel profile" },
      { label: "Face", value: "Acrylic 3–5 mm (opal, tinted or frosted)" },
      { label: "Lighting", value: "SMD LED modules, 12V / 24V, IP65" },
      { label: "Power", value: "Constant-voltage LED driver with fused protection" },
  ...
  "kutu-harf-tabela": {
    ...
    highlights: [
      {
        title: "CNC precision",
        description: "Cut straight from vector files so your typography stays intact.",
      },
      {
      ...
      },
      {
        ...
        description: "Standoffs and fixings are stainless, so no rust staining develops.",
      },
      {
    ...
    highlights: [
      {
        ...
        description: "Steel frame and concrete foundation sized against wind load.",
      },
      { title: "Double-sided", description: "Legible from both directions of traffic." },
      {
        title: "Modular cassettes",
        description: "Multi-tenant totems allow individual panels to be replaced.",
      },
      {
        title: "Turnkey delivery",
        description: "Excavation, concrete, power supply and installation in one contract.",
      },
    ],
    specs: [
  ...
  "lightbox-tabela": {
    ...
    highlights: [
      { title: "4–8 cm profile", description: "Edge-lit panels keep the frame nearly flush." },
      {
      ...
      {
        title: "No hot spots",
        description: "A diffuser layer gives even brightness across the whole face.",
      },
      {
  ...
  "cephe-giydirme": {
    ...
    highlights: [
      ...
      },
      {
        ...
        description: "Mineral-filled, limited-combustibility panel for regulated buildings.",
      },
      {
        title: "Mesh vinyl option",
        description: "Reduces wind load on temporary and construction-phase installations.",
      },
      {
    ...
    specs: [
      { label: "Primary material", value: "Aluminium composite panel (ACP) 4 mm" },
      { label: "Fire class", value: "B-s1 standard / A2-s1 mineral filled" },
      { label: "Alternatives", value: "Mesh vinyl, acrylic, HPL" },
      { label: "Sub-frame", value: "Aluminium carcass with expansion allowance" },
    ...
    highlights: [
      {
        ...
        description: "Conforms to curves without shrink-back; 5–7 year UV durability.",
      },
      {
        title: "Paint-safe",
        description: "Heat-assisted removal leaves the factory finish intact — and protected.",
      },
      {
      ...
      },
      {
        ...
        description: "Applied indoors so no bubbles or dust are trapped under the film.",
      },
    ],
    specs: [
    ...
    highlights: [
      {
        ...
        description: "Your corporate colour reads the same across every material and job.",
      },
      {
        title: "High resolution",
        description: "Up to 1440 dpi for close-viewed work; optimised output for distance.",
      },
      {
        title: "Correct substrate",
        description: "Material recommended against lifespan and location, not habit.",
      },
      {
        title: "Finishing in-house",
        description: "Welded hems, eyelets and cutting completed alongside printing.",
      },
    ],
    specs: [
      { label: "Technology", value: "Eco-solvent, latex and UV" },
      { label: "Materials", value: "Vinyl, PVC banner, mesh, film, canvas, one-way vision" },
  ...
  "kurumsal-kimlik": {
    ...
    highlights: [
      {
        ...
        description: "Marks are tested for cutting and single-colour use, not just on screen.",
      },
      {
        title: "Complete colour definition",
        description: "Pantone, CMYK, RGB and RAL references so paint matches print.",
      },
      {
    ...
    specs: [
      ...
      { label: "Colour system", value: "Pantone, CMYK, RGB and RAL references" },
      { label: "Typography", value: "Primary and secondary families with hierarchy" },
      { label: "Guidelines", value: "PDF identity manual with misuse examples" },
      { label: "Print set", value: "Business cards, letterhead, envelope, folder" },
      { label: "Digital set", value: "Social templates and email signature" },
      { label: "Applications", value: "Signage, vehicle, façade and uniform visuals" },
    ...
    highlights: [
      {
        ...
        description: "Any shape, including logo outlines — no rectangle requirement.",
      },
      { title: "Short runs", description: "Digital production makes runs of 50 economical." },
      {
        title: "Application-matched stock",
        description: "Moisture-resistant, clear, static-cling or non-slip options.",
      },
      {
        title: "Residue-free removal",
        description: "Removable adhesives specified for glazing and window work.",
      },
    ],
    specs: [
      { label: "Materials", value: "PVC film, clear film, coated label stock, floor film" },
  ...
  "imalat-tasarim-montaj": {
    ...
    highlights: [
      ...
      },
      {
        ...
        description: "Nothing outsourced, so delivery dates can be committed and quality controlled.",
      },
      {
        title: "Nationwide installation",
        description: "Consistent standards for multi-site brands across Türkiye.",
      },
      {
        title: "Survey and permit support",
        description: "On-site measurement, technical drawings and application documentation.",
      },
    ],
    specs: [
      { label: "Survey", value: "Free on-site survey within Samsun" },
      { label: "Design", value: "3D visualisation and façade mounting simulation" },
      { label: "Fabrication", value: "In-house CNC cutting, welding and finishing" },
  ...
  "yol-panolari": {
    ...
    tagline: "Accurate Direction",
    summary:
      "Large-scale and durable road signs directing your customers to your business in outdoor areas.",
    answer: "Large-scale road signs directing your customers to your business in outdoor areas.",
    metaTitle: "Road Signs",
    metaDescription: "Road and directional signs",
    keywords: [],
    intro: [],
    highlights: [],
    specs: [],
  ...
  "led-ekranlar": {
    ...
    tagline: "Dynamic Display",
    summary:
      "High-resolution outdoor and indoor LED screen systems for dynamic advertising and video displays.",
    answer: "High-resolution LED screens for dynamic advertising and video displays.",
    metaTitle: "LED Screens",
    metaDescription: "Outdoor LED screen",
    keywords: [],
    intro: [],
    highlights: [],
    specs: [],
